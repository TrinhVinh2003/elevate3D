...
if (isPost()) {
    ...
    if (empty($filterAll['description'])) {
        $errors['description']['required'] = 'Vui lòng nhập description';
    }
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid px-4 pt-3 border">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"> Thêm email </li>
                </ul>
            </div>

            <div class="container-fluid px-4">
                <h1 class="mt-4">Thêm email</h1>
            </div>
            ...
            <div class="container-fluid px-4">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group mg-form">
                                    ...
                                    <input class="form-control" type="name" placeholder="Họ và tên" name="name"
                ...
                <div class="row d-grid gap-2 justify-content-center">
                    <button class="btn btn-primary" type="submit">Thêm email</button>
                    <a href="?module=admin&action=email_management" class="btn btn-success" type="button">Quay lại</a>
                </div>
                </form>
            </div>
        </div>
