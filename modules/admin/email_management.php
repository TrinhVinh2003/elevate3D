    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                <h1 class="mt-4">Danh sách email</h1>
            </div>
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    ...
                    <div class="col overflow-auto">
                        <a href="?module=admin&action=email_add" class="btn btn-success"><i class="fa-solid fa-plus"></i> Thêm email</a>
                        <table class="table bg-white rounded shadow-sm table-hover mt-3" id="datatable">
                            ...
                            <tbody>
                                <?php
                                $listEmail = getRaw("SELECT * FROM email");
                                if (!empty($listEmail)):
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo "?module=admin&action=email_edit&id=" . $item['id'] ?>" class="btn btn-warning btn-sm"><i class="fa-solid fa-pen-to-square"></i></a></td>
                                            <td><a href="<?php echo "?module=admin&action=email_delete&id=" . $item['id'] ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa không?')" class="btn btn-danger btn-sm">
                                    ...
                                    <tr>
                                        <td colspan="7">
                                            <div class="alert alert-danger text-center">Không có email nào!</div>
                                        </td>
                                    </tr>
                                <?php
                                endif;
