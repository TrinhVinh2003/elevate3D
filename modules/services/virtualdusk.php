...
$title = [
    'pageTitle' => 'Virtual Dusk - An Affordable Alternative to Twilight Photos'
];
    ...
    <div class="w-layout-blockcontainer container w-container">
        <div class="services-hero-wrapper">
            <div class="left-text-wrapper">
                <h1 class="heading tablet services-hero mobile">An Affordable Alternative to Twilight Photos
                </h1>
                <p class="p2 tablet mobile">Provide realtors with the perfect solution to night photography—no timing, lighting, or weather limitations, all at a lower cost </p>

            </div>
            <div class="services-hero-image"><img
                    src="/3DELEVATE/assets/img/services/virtualdusk/virtualdusk_1.jpeg"
        ...
        <div class="w-layout-blockcontainer container w-container">
            ...
            <div class="beforenafter-large">
                <div class="image-wrapper"><img data-beer-label="after"
                        src="/3DELEVATE/assets/img/services/virtualdusk/virtualdusk_2.jpeg"
                        ...
                        src="/3DELEVATE/assets/img/services/virtualdusk/virtualdusk_3.jpeg"
                        alt="" loading="lazy"
    ...
    <section class="section-2">
        <div class="w-layout-blockcontainer container-10 w-container">
            <div class="wrapper-image-small">
                <div class="image-wrapper"><img data-beer-label="after"
                        src="/3DELEVATE/assets/img/services/virtualdusk/virtualdusk_5.jpeg"
                        alt="" loading="lazy" sizes="(max-width: 767px) 100vw, 700px"
                        class="image-two" /><img data-beer-label="before"
                        src="/3DELEVATE/assets/img/services/virtualdusk/virtualdusk_6.jpeg"
                        alt="" loading="lazy"
            ...
            <div class="wrapper-image-small">
                <div class="image-wrapper"><img data-beer-label="after"
                        src="/3DELEVATE/assets/img/services/virtualdusk/virtualdusk_7.jpeg"
                        alt="" loading="lazy" sizes="(max-width: 767px) 100vw, 700px"
                        class="image-two" /><img data-beer-label="before"
                        src="/3DELEVATE/assets/img/services/virtualdusk/virtualdusk_8.jpeg"
                        alt="" loading="lazy"
